...
public class PubSubServiceAutoConfiguration {
	...
	public static class PubSubConfiguration {
		...
		public PubSub pubSubCloud(Environment environment) throws Exception {
			...
			return PubSubOptions.newBuilder().setAuthCredentials(AuthCredentials.createFor(googleCredential.getServiceAccountId(), googleCredential.getServiceAccountPrivateKey())).build().getService();
		}
	}
